...
pub async fn add_all_application_commands(gid: &mut GuildId, ctx: &Context) -> Vec<Command> {
    ...
    .set_commands(
        ...
        .add_option(
            CreateCommandOption::new(
                CommandOptionType::SubCommand, "guild", "All guild-wide settings")
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::Boolean, "allow_ping", "Allow members without explicit permissions to use /ping.")
                    .required(false)
                )
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::Integer, "set_guild_ping_cooldown", "Set the duration of the guild-wide cooldown.")
                    .required(false)
                )
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::Integer, "set_list_ping_cooldown", "Set the cooldown between seperate pings to the same list in seconds.")
                    .required(false)
                )
            )
        .add_option(
            CreateCommandOption::new(CommandOptionType::SubCommand, "role", "Settings that affect a specific role")
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::Role, "role", "The role to configure.")
                    .required(true)
                )
                .add_sub_option(
                ...
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::String, "ping", "Toggle whether or not people with this role can use /ping.")
                    .required(false)
                    .add_string_choice("Reset", "0")
                    .add_string_choice("Deny", "1")
                    .add_string_choice("Allow", "2")
        ...
        .add_option(
            CreateCommandOption::new(CommandOptionType::SubCommand, "user", "Settings that affect a specific user")
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::User, "user", "The user to configure.")
                    .required(true)
                )
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::String, "propose", "Toggle whether or not people with this user can use /propose.")
                    .required(false)
                    .add_string_choice("Reset", "0")
                    .add_string_choice("Deny", "1")
                    .add_string_choice("Allow", "2")
                ...
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::String, "ping", "Toggle whether or not people with this user can use /ping.")
                    .required(false)
                    .add_string_choice("Reset", "0")
                    .add_string_choice("Deny", "1")
                    .add_string_choice("Allow", "2")
                ...
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::Boolean, "exclude_from_cooldown", "Toggle whether or not people with this user can ignore the guild-wide cooldown.")
                    .required(false)
                )
            )
        .add_option(
            CreateCommandOption::new(CommandOptionType::SubCommand, "list", "All settings that affect a single pinglist")
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::String, "list", "The list to configure.")
                    .required(true)
                    .set_autocomplete(true)
                )
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::String, "description", "Set the list description.")
                    .required(false)
                )
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::Integer, "cooldown", "Override the list cooldown.")
                    .required(false)
                )
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::String, "allow_join", "Allow anyone to join or leave this list.")
                    .required(false)
                    .add_string_choice("Reset", "0")
                    .add_string_choice("Deny", "1")
                    .add_string_choice("Allow", "2")
                ...
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::String, "allow_ping", "Allow anyone to mention this list.")
                    .required(false)
                    .add_string_choice("Reset", "0")
                    .add_string_choice("Deny", "1")
                    .add_string_choice("Allow", "2")
                ...
                .add_sub_option(
                    CreateCommandOption::new(CommandOptionType::Boolean, "show", "Hide this list from /list.")
                    .required(false)
                )
        )
        .add_option(
            ...
            .add_sub_option(
                CreateCommandOption::new(CommandOptionType::Channel, "channel", "The channel to configure")
                .required(true)
            )
            .add_sub_option(
            ...
            .add_sub_option(
                CreateCommandOption::new(CommandOptionType::Boolean, "visible_commands", "Whether or not commands like /list are visible in this channel.")
                .required(false)
                )
            )
        .add_option(
        ...
        .add_option(
            CreateCommandOption::new(CommandOptionType::SubCommandGroup, "cache", "Settings that monitor the user cache")
            .add_sub_option(
                CreateCommandOption::new(CommandOptionType::SubCommand, "show_status", "Get the cache status")
            )
            .add_sub_option(
                CreateCommandOption::new(CommandOptionType::SubCommand, "refresh_cache", "Refresh the cache")
            )
        )
    ]
)
